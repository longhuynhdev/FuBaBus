        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-xl">
              Hóa đơn: <span className="text-orange-600">{invoiceData?.invoiceID}</span>
            </DialogTitle>
          </DialogHeader>
          ...
          {invoiceData && (
            <div className="space-y-6">
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input value={invoiceData.name} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Tổng giá vé:</Label>
                    <Input value={invoiceData.price} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Số điện thoại:</Label>
                    <Input value={invoiceData.phone} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">PTTT:</Label>
                    <Input value={invoiceData.paymentMethod} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Email:</Label>
                    <Input value={invoiceData.email} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Trạng thái:</Label>
                    <Input value={invoiceData.status} disabled className="mt-1 bg-white" />
                  </div>
                </div>
              </div>
              ...
              {/* Invoice Details */}
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-700">Chi tiết hóa đơn</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label className="text-sm font-medium">Tuyến xe:</Label>
                    <Input value={invoiceData.buses} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Xuất bến:</Label>
                    <Input value={invoiceData.time} disabled className="mt-1 bg-white" />
                  </div>
                </div>
                <div>
                  <Label className="text-sm font-medium">Số ghế:</Label>
                  <Input value={invoiceData.seats} disabled className="mt-1 bg-white" />
                </div>
                <div>
                  <Label className="text-sm font-medium">Điểm lên xe:</Label>
                  <Input value={invoiceData.boardingPoint} disabled className="mt-1 bg-white" />
                </div>
              </div>
            </div>
          )}
