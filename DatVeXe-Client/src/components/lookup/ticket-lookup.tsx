        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-xl">
              Mã vé xe: <span className="text-orange-600">{formLookup.ticketID}</span>
            </DialogTitle>
          </DialogHeader>
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input value="Long Huynh" disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Email:</Label>
                    <Input value="suikax86@gmail.com" disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Số điện thoại:</Label>
                    <Input value={formLookup.phoneNumber} disabled className="mt-1 bg-white" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input value={ticketData.busId} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Mã khách hàng:</Label>
                    <Input value={ticketData.customerId} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Giờ khởi hành:</Label>
                    <Input value={ticketData.departureTime} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Địa điểm đi:</Label>
                    <Input value={ticketData.departureLocation} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Thời gian đến:</Label>
                    <Input value={ticketData.arrivalTime} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Địa điểm đến:</Label>
                    <Input value={ticketData.arrivalLocation} disabled className="mt-1 bg-white" />
                  </div>
                </div>
                <div>
                  <Label className="text-sm font-medium">Điểm đón:</Label>
                  <Input value={ticketData.boardingPoint} disabled className="mt-1 bg-white" />
                </div>
                <div>
                  <Label className="text-sm font-medium">Điểm xuống:</Label>
                  <Input value={ticketData.droppingPoint} disabled className="mt-1 bg-white" />
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label className="text-sm font-medium">Loại xe bus:</Label>
                    <Input value={ticketData.busType} disabled className="mt-1 bg-white" />
                  </div>
                  <div>
                    <Label className="text-sm font-medium">Tổng tiền vé:</Label>
                    <Input value={ticketData.totalFare} disabled className="mt-1 bg-white" />
                  </div>
                </div>
                <div>
                  <Label className="text-sm font-medium">Danh sách ghế đặt:</Label>
                  <Input value={ticketData.seats} disabled className="mt-1 bg-white" />
                </div>
              </div>
            </div>
          )}
